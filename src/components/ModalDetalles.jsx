    ...
    <>
      ...
      {isopen && (
        <div className="fixed z-200  inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center">
          <div className="bg-white p-5 rounded-lg flex flex-col gap-5 h-[80vh] w-[120vh] overflow-auto">
            <div className="p-4 space-y-2">
              <div className="flex justify-between items-start">
                ...
                <div className="space-x-4">
                  <button className="text-blue-600 hover:bg-blue-100 cursor-pointer rounded-lg p-2 text-sm">
                    + Agregar referencia
                  </button>
                  <button
                    type="button"
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 m-8 space-y-2">
